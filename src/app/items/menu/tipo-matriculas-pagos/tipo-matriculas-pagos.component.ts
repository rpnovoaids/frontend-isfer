...
@Component({
  selector: 'app-tipo-matriculas-pagos',
  templateUrl: './tipo-matriculas-pagos.component.html',
  styleUrls: ['./tipo-matriculas-pagos.component.css'],
  providers: [
    AuthService,
    AjustesService
  ]
})
export class TipoMatriculasPagosComponent implements OnInit {

  title = 'Tipo de Matriculas Y Pagos';
  msgs: any;
  token: any;
  es: any;
